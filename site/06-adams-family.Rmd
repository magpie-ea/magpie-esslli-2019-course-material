...
Here is the example of the [preregistration report discussed in class](materials/prereg_report_Adams.pdf), together with the [pre-registered analysis file](materials/data_analysis_prereg.R) and the [pilot data](materials/data_raw_pilot.csv). The official preregistration at [osf.io](osf.io) can be found [here](osf.io/a36p7). The experiment can be inspected [here](https://magpie-exp-adams-family.netlify.com).
