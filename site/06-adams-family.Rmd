...
Here is an example of a [preregistration report]('materials/prereg_report_Adams.pdf'), together with the [pre-registered analysis file](materials/data_analysis.R) and the [pilot data](materials/pilot_data.csv).
